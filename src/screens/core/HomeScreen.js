...
import { useDashboardViewModel, useWeatherViewModel } from '../../viewmodels';
...
export default function HomeScreen() {
  ...
  const { weather, loading: weatherLoading, error: weatherError } = useWeatherViewModel();
      ...
      <ScrollView contentContainerStyle={styles.appended}>
        ...
        <View style={styles.section}>
          ...
          {weatherLoading ? (
            ...
            <View>
              <Text style={styles.weatherText}>{weather ? `${weather.temperature}°C · ${weather.condition}` : 'Weather unavailable'}</Text>
